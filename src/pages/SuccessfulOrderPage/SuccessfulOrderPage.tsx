...
import { setRating } from 'state/reducers/setUserInfoSlice';

import CostWidget from 'components/CostWidget/CostWidget';
import RatingStars from 'views/RatingStars/RatingStars';
      ...
      <div className="successful-order__wrapper">
        <main className="successful-order__container">
          ...
          <div className="successful-order__content">
            <p className="successful-order__passenger-name">{`${name} ${patronymic}`}!</p>
            ...
            <div className="rating__container">
              ...
              <div className="rating-star__wrapper">
                <RatingStars
                  count={5}
                  rating={rating}
                  setRating={(number) => dispatch(setRating(number))}
                />
              </div>
            </div>
